# Research Prompt: Historical Examples of "Moderate Growth"
...
Adequate capacity across the board, nothing exceptional. Moderate beauty, moderate rotation, reasonable trust.

### Dynamics

Growth exceeds decay by a comfortable margin. No single parameter is a bottleneck, but none is a lever either. The system hums along.

### Outcome

Steady positive trajectory. S stays above S̄ with margin to spare. Not exciting, but sustainable. Many healthy mature organizations live here.

---

## Research Task

Please identify **3 compelling historical examples** of organizations, institutions, movements, or groups that exemplify the "Moderate Growth" archetype.
