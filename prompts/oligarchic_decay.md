# Research Prompt: Historical Examples of "Oligarchic Decay"

## The Dionysus Program: Overview
...
## The Archetype: Oligarchic Decay
...
Very low rotation rate (ρ), substantial ritual capacity. Leaders stay in place; stewardship is not refreshed.

### Dynamics

C drifts toward zero as (1-δ)^t compounds. Omega shrinks even though L and R haven't changed. Overflow grows. The rituals nominally exist but have been captured by a permanent priesthood who cannot allow their own forms to be questioned. Weber and Michels were right.

### Outcome

Internal collapse via stewardship failure. The iron law of oligarchy in action. The solution is rotation—but by the time this pattern is visible, the incumbents have strong incentives to resist it.

---

## Research Task

Please identify **3 compelling historical examples** of organizations, institutions, movements, or groups that exemplify the "Oligarchic Decay" archetype.
